...
Using the skills you've just developed, you're now going to analyse an entirely new dataset, the `beetles.txt` dataset on MyAberdeen. This data comes from a lab experiment from researchers who were interested in understanding how temperature impacts fecundity in BBB beetles (BBB BBB), ultimately attempting to understanding how the species may respond to climate change.
...
beetles$offspring <- round(rnorm(n, mean = mu, sd = 30), digits = 0)
